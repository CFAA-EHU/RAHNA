...
The code is contained in the folder 'proyecto-RAG', which has its own README explaining how to replicate it.
...
- LLM (MistralAI): Receives the user's question and relevant documents and gives an answer.
- Integration framework (Langchain): Coordinates the RAG pipeline.

![Architecture diagram](imgs/Architecture%20diagram.png)
